...
ActiveRecord::Schema[8.1].define(version: 2026_03_18_013736) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.check_constraint "ai_sentiment_score IS NULL OR ai_sentiment_score >= '-1.0'::numeric::double precision AND ai_sentiment_score <= 1.0::double precision", name: "messages_ai_sentiment_score_range"
  end
